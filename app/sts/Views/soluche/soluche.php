...
<body style="background: url(<?php echo URLADM; ?>app/sts/assets/images/Papel_Parede.jpg) left center;">
    ...
    <div class="container max-width">
            ...
            if (!empty($this->data['soluche'])) {

                foreach ($this->data['soluche'] as $soluche) {

                    extract($soluche);

                    

                    //echo ('<pre>');print_r($soluche);echo ('</pre>');
                        ...
                        <div class="mt-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col md-12">
                                    ...
                                    <div>
                                        ...
                                        <img src="<?php echo URLADM; ?>app/sts/assets/images/soluche/<?php if (isset($image_top )) {echo $image_top ;}?>" class="d-block w-100">
                            ...
                            <div class="row">
                                ...
                                <div class="col md-4 conteudo-produtos centralizar">
                                    ...
                                    <h4 class="mt-3"><?php if (isset($title_left )) {echo $title_left ;}?></h4>
                                ...
                                <div class="col md-4 conteudo-produtos centralizar">
                                    ...
                                    <h4 class="mt-3"><?php if (isset($title_center )) {echo $title_center ;}?><br><br></h4>
                                ...
                                <div class="col md-4 conteudo-produtos centralizar">
                                    ...
                                    <h4 class="mt-3"><?php if (isset($title_right )) {echo $title_right ;}?><br> <br> </h4>
                            ...
                            <div class="row">
                                ...
                                <div class="col md-12">
                                    ...
                                    <div>
                                        ...
                                        <img src="<?php echo URLADM; ?>app/sts/assets/images/soluche/<?php if (isset($image_center )) {echo $image_center ;}?>" class="d-block w-100">
