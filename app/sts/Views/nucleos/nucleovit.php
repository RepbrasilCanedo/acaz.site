...
<body style="background: url(<?php echo URL; ?>app/sts/assets/images/Papel_Parede.jpg) left center;">
    <div class="container max-width">
            ...
            <section class="mb-3">
                ...
                if (!empty($this->data['nucleovit']['conteudo'])) {
                    foreach($this->data['nucleovit']['conteudo'] as $nucleovit) {
                        extract($nucleovit);
                    //echo('<pre>');print_r($nucleovit); echo('</pre>');
                ?>
                    <!-- Título e texto da pagina --> 
                    <div class="row m-2">
                        <div class="col-md-4">                            
                            <img src="<?php echo URLADM; ?>app/sts/assets/images/nucleovit/<?php if (isset($image)) {echo $image;} ?>" class="img-thumbnail d-block w-100" alt="Imagem de roda de capoeira">
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="row m-2">
                        ...
                        <div class="col-md-4">
                            <img src="<?php echo URLADM; ?>app/sts/assets/images/nucleovit/<?php if (isset($image_2)) {echo $image_2;} ?>" class="img-thumbnail d-block w-100" alt="Imagem de roda de capoeira">
                        </div>
                    </div>
                    ...
                    <div class="row m-2">
                        <div class="col-md-3">
                            <div>
                                <img src="<?php echo URLADM; ?>app/sts/assets/images/nucleovit/<?php if (isset($image_3)) {echo $image_3;} ?>" class="img-thumbnail d-block w-100"alt="Imagem de roda de capoeira">
                        ...
                        <div class="col-md-3">
                            <div>
                                <img src="<?php echo URLADM; ?>app/sts/assets/images/nucleovit/<?php if (isset($image_4)) {echo $image_4;} ?>" class="img-thumbnail d-block w-100"alt="Imagem de roda de capoeira">
                        ...
                        <div class="col-md-3">
                            <div>
                                <img src="<?php echo URLADM; ?>app/sts/assets/images/nucleovit/<?php if (isset($image_5)) {echo $image_5;} ?>" class="img-thumbnail d-block w-100"alt="Imagem de roda de capoeira">
                        ...
                        <div class="col-md-3">
                            <div>
                                <img src="<?php echo URLADM; ?>app/sts/assets/images/nucleovit/<?php if (isset($image_6)) {echo $image_6;} ?>" class="img-thumbnail d-block w-100"alt="Imagem de roda de capoeira">
                    ...
                    <div class="row m-2">
                        <div class="col-md-3">
                            <div>
                                <img src="<?php echo URLADM; ?>app/sts/assets/images/nucleovit/<?php if (isset($image_7)) {echo $image_7;} ?>" class="img-thumbnail d-block w-100"alt="Imagem de roda de capoeira">
                        ...
                        <div class="col-md-3">
                            <div>
                                <img src="<?php echo URLADM; ?>app/sts/assets/images/nucleovit/<?php if (isset($image_8)) {echo $image_8;} ?>" class="img-thumbnail d-block w-100"alt="Imagem de roda de capoeira">
                        ...
                        <div class="col-md-3">
                            <div>
                                <img src="<?php echo URLADM; ?>app/sts/assets/images/nucleovit/<?php if (isset($image_9)) {echo $image_9;} ?>" class="img-thumbnail d-block w-100"alt="Imagem de roda de capoeira">
                        ...
                        <div class="col-md-3">
                            <div>
                            <img src="<?php echo URLADM; ?>app/sts/assets/images/nucleovit/<?php if (isset($image_10)) {echo $image_10;} ?>" class="img-thumbnail d-block w-100"alt="Imagem de roda de capoeira">
                    ...
                    <div class="row m-2">
                        <div class="col-md-8">
                            ...
                            <img src="<?php echo URLADM; ?>app/sts/assets/images/nucleovit/<?php if (isset($image_11)) {echo $image_11;} ?>" class="img-thumbnail d-block w-100"alt="Imagem de roda de capoeira">
                                
                        </div>
                        <div class="col-md-4">
                            <h4 class="mt-3 centralizar">Divulgação</h4>     
                            <img src="<?php echo URLADM; ?>app/sts/assets/images/nucleovit/<?php if (isset($image_12)) {echo $image_12;} ?>" class="img-thumbnail d-block w-100"alt="Imagem de roda de capoeira">
            ...
            <session class="mb-3">
                <div class="row">
                    <div class="col md-12">         
                        <?php
                        // Acessa o IF quando encontrou algum registro no banco de dados
                        if (!empty($this->data['nucleovit']['carroussel'][0])) {
                            extract($this->data['nucleovit']['carroussel'][0]);
                        ...
                        <div id="carousel_imagens" class="carousel slide" data-ride="carousel" >
                                ...
                                <div class="carousel-item  active">
                                    <img src="<?php echo URLADM; ?>app/sts/assets/images/carrouselvitoria/<?php if (isset($image_1)) {echo $image_1;}?>" class="d-block w-100" alt="Imagem de roda de capoeira">
                                ...
                                <div class="carousel-item">
                                    <img src="<?php echo URLADM; ?>app/sts/assets/images/carrouselvitoria/<?php if (isset($image_2)) {echo $image_2;}?>" class="d-block w-100" alt="Imagem de roda de capoeira">
                                    <div class="carousel-caption d-none d-md-block">
                                    ...
                                    <div class="carousel-item">
                                        <img src="<?php echo URLADM; ?>app/sts/assets/images/carrouselvitoria/<?php if (isset($image_3)) {echo $image_3;}?>" class="d-block w-100" alt="Imagem de roda de capoeira">
                                        <div class="carousel-caption d-none d-md-block">
                                    ...
                                    <div class="carousel-item">
                                        <img src="<?php echo URLADM; ?>app/sts/assets/images/carrouselvitoria/<?php if (isset($image_4)) {echo $image_4;}?>" class="d-block w-100" alt="Imagem de roda de capoeira">
                                        <div class="carousel-caption d-none d-md-block">
                                    ...
                                    <div class="carousel-item">
                                        <img src="<?php echo URLADM; ?>app/sts/assets/images/carrouselvitoria/<?php if (isset($image_5)) {echo $image_5;}?>" class="d-block w-100" alt="Imagem de roda de capoeira">
                                        <div class="carousel-caption d-none d-md-block">
                                    ...
                                    <div class="carousel-item">
                                        <img src="<?php echo URLADM; ?>app/sts/assets/images/carrouselvitoria/<?php if (isset($image_6)) {echo $image_6;}?>" class="d-block w-100" alt="Imagem de roda de capoeira">
                                        <div class="carousel-caption d-none d-md-block">
