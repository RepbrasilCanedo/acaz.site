...
<body style="background: url(<?php echo URL; ?>app/sts/assets/images/Papel_Parede.jpg) left center;">
    <div class="container max-width">
            ...
            <section class="mb-3">
                ...
                if (!empty($this->data['nucleocanIII']['conteudo'])) {
                    foreach($this->data['nucleocanIII']['conteudo'] as $nucleocanIII) {
                        extract($nucleocanIII);
                    //echo('<pre>');print_r($nucleocanIII); echo('</pre>');
                ?>
                    <!-- Título e texto da pagina --> 
                    <div class="row m-2">
                        <div class="col-md-4">                            
                            <img src="<?php echo URLADM; ?>app/sts/assets/images/nucleocanIII/<?php if (isset($image)) {echo $image;} ?>" class="img-thumbnail d-block w-100" alt="Imagem de roda de capoeira">
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="mapa">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d4676.5719099067055!2d-38.943225!3d-15.682691000000002!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zMTXCsDQwJzU3LjciUyAzOMKwNTYnMzUuNiJX!5e1!3m2!1spt-BR!2sbr!4v1744130457067!5m2!1spt-BR!2sbr" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                        </div>
                        </div>
                    </div>
                    <!-- Título e texto da pagina --> 
                    <div class="row m-2">
                        ...
                        <div class="col-md-4">
                            <img src="<?php echo URLADM; ?>app/sts/assets/images/nucleocanIII/<?php if (isset($image_2)) {echo $image_2;} ?>" class="img-thumbnail d-block w-100" alt="Imagem de roda de capoeira">
                        </div>
                    </div>
                    ...
                    <div class="row m-2">
                        <div class="col-md-3">
                            <div>
                                <img src="<?php echo URLADM; ?>app/sts/assets/images/nucleocanIII/<?php if (isset($image_3)) {echo $image_3;} ?>" class="img-thumbnail d-block w-100"alt="Imagem de roda de capoeira">
                        ...
                        <div class="col-md-3">
                            <div>
                                <img src="<?php echo URLADM; ?>app/sts/assets/images/nucleocanIII/<?php if (isset($image_4)) {echo $image_4;} ?>" class="img-thumbnail d-block w-100"alt="Imagem de roda de capoeira">
                        ...
                        <div class="col-md-3">
                            <div>
                                <img src="<?php echo URLADM; ?>app/sts/assets/images/nucleocanIII/<?php if (isset($image_5)) {echo $image_5;} ?>" class="img-thumbnail d-block w-100"alt="Imagem de roda de capoeira">
                        ...
                        <div class="col-md-3">
                            <div>
                                <img src="<?php echo URLADM; ?>app/sts/assets/images/nucleocanIII/<?php if (isset($image_6)) {echo $image_6;} ?>" class="img-thumbnail d-block w-100"alt="Imagem de roda de capoeira">
                    ...
                    <div class="row m-2">
                        <div class="col-md-3">
                            <div>
                                <img src="<?php echo URLADM; ?>app/sts/assets/images/nucleocanIII/<?php if (isset($image_7)) {echo $image_7;} ?>" class="img-thumbnail d-block w-100"alt="Imagem de roda de capoeira">
                        ...
                        <div class="col-md-3">
                            <div>
                                <img src="<?php echo URLADM; ?>app/sts/assets/images/nucleocanIII/<?php if (isset($image_8)) {echo $image_8;} ?>" class="img-thumbnail d-block w-100"alt="Imagem de roda de capoeira">
                        ...
                        <div class="col-md-3">
                            <div>
                                <img src="<?php echo URLADM; ?>app/sts/assets/images/nucleocanIII/<?php if (isset($image_9)) {echo $image_9;} ?>" class="img-thumbnail d-block w-100"alt="Imagem de roda de capoeira">
                        ...
                        <div class="col-md-3">
                            <div>
                            <img src="<?php echo URLADM; ?>app/sts/assets/images/nucleocanIII/<?php if (isset($image_10)) {echo $image_10;} ?>" class="img-thumbnail d-block w-100"alt="Imagem de roda de capoeira">
                    ...
                    <div class="row m-2">
                        <div class="col-md-8">
                            ...
                            <img src="<?php echo URLADM; ?>app/sts/assets/images/nucleocanIII/<?php if (isset($image_11)) {echo $image_11;} ?>" class="img-thumbnail d-block w-100"alt="Imagem de roda de capoeira">
              ...
              <div class="col md-12">         
                ...
                <div id="carousel_imagens" class="carousel slide" data-ride="carousel" >
                        ...
                        <div class="carousel-item  active">
                            <img src="<?php echo URLADM; ?>app/sts/assets/images/carrouselnuctres/<?php if (isset($image_1)) {echo $image_1;}?>" class="d-block w-100" alt="Imagem de roda de capoeira">
                        ...
                        <div class="carousel-item">
                            <img src="<?php echo URLADM; ?>app/sts/assets/images/carrouselnuctres/<?php if (isset($image_2)) {echo $image_2;}?>" class="d-block w-100" alt="Imagem de roda de capoeira">
                            <div class="carousel-caption d-none d-md-block">
                            ...
                            <div class="carousel-item">
                                <img src="<?php echo URLADM; ?>app/sts/assets/images/carrouselnuctres/<?php if (isset($image_3)) {echo $image_3;}?>" class="d-block w-100" alt="Imagem de roda de capoeira">
                                <div class="carousel-caption d-none d-md-block">
                            ...
                            <div class="carousel-item">
                                <img src="<?php echo URLADM; ?>app/sts/assets/images/carrouselnuctres/<?php if (isset($image_4)) {echo $image_4;}?>" class="d-block w-100" alt="Imagem de roda de capoeira">
                                <div class="carousel-caption d-none d-md-block">
                            ...
                            <div class="carousel-item">
                                <img src="<?php echo URLADM; ?>app/sts/assets/images/carrouselnuctres/<?php if (isset($image_5)) {echo $image_5;}?>" class="d-block w-100" alt="Imagem de roda de capoeira">
                                <div class="carousel-caption d-none d-md-block">
                            ...
                            <div class="carousel-item">
                                <img src="<?php echo URLADM; ?>app/sts/assets/images/carrouselnuctres/<?php if (isset($image_6)) {echo $image_6;}?>" class="d-block w-100" alt="Imagem de roda de capoeira">
                                <div class="carousel-caption d-none d-md-block">
