...
<body style="background: url(<?php echo URL; ?>app/sts/assets/images/Papel_Parede.jpg) left center;">
  <div class="container max-width">
    ...
    <section class="mb-3">
      ...
      if (!empty($this->data['nucleocanI']['conteudo'][0])) {
        ...
        <h4 class="mt-4 centralizar">NÚCLEO I - MESTRE GALEGO</h4>
        <div class="centralizar">
        <div class="card mb-3">
            <div class="row g-0 align-items-center">
            <div class="col-md-6 d-flex justify-content-center">
              <img src="<?php echo URLADM; ?>app/sts/assets/images/nucleocanI/<?php if (isset($image)) {
                echo $image;
              ...
              <div class="row g-0">
                ...
                <div class="col-md-4">
                  ...
                  <div class="card-body mapa-container">
                    <iframe
                      src="https://www.google.com/maps/embed?pb=!1m13!1m8!1m3!1d292.3082898733347!2d-38.9470629!3d-15.6669421!3m2!1i1024!2i768!4f13.1!3m2!1m1!2s!5e1!3m2!1spt-BR!2sbr!4v1744130368661!5m2!1spt-BR!2sbr"
                ...
                <div class="col-md-4">
                  ...
                  <img src="<?php echo URLADM; ?>app/sts/assets/images/nucleocanI/<?php if (isset($image_13)) {
                     echo $image_13;
          ...
          <div class="row m-2">
            <div class="col-md-3">
              <div>
                <img src="<?php echo URLADM; ?>app/sts/assets/images/nucleocanI/<?php if (isset($image_3)) {
                     echo $image_3;
            ...
            <div class="col-md-3">
              <div>
                <img src="<?php echo URLADM; ?>app/sts/assets/images/nucleocanI/<?php if (isset($image_4)) {
                     echo $image_4;
                   } ?>" class="img-thumbnail d-block w-100" alt="Imagem de roda de capoeira">
            ...
            <div class="col-md-3">
              <div>
                <img src="<?php echo URLADM; ?>app/sts/assets/images/nucleocanI/<?php if (isset($image_5)) {
                     echo $image_5;
                   } ?>" class="img-thumbnail d-block w-100" alt="Imagem de roda de capoeira">
            ...
            <div class="col-md-3">
              <div>
                <img src="<?php echo URLADM; ?>app/sts/assets/images/nucleocanI/<?php if (isset($image_6)) {
                     echo $image_6;
                   } ?>" class="img-thumbnail d-block w-100" alt="Imagem de roda de capoeira">
            ...
            <div id="carousel_imagens" class="carousel slide" data-ride="carousel">
              ...
              <div class="carousel-inner">
                <div class="carousel-item  active">
                  <img src="<?php echo URLADM; ?>app/sts/assets/images/carrouselnucum/<?php if (isset($image_1)) {
                       echo $image_1;
                  ...
                  <div class="carousel-caption d-none d-md-block">
                    ...
                    <p class="todas-maiusculas texto-carrousel"><?php if (isset($sub_title_1)) {
                      echo $sub_title_1;
                    } ?>
                    </p>
                  </div>
                ...
                <div class="carousel-item">
                  <img src="<?php echo URLADM; ?>app/sts/assets/images/carrouselnucum/<?php if (isset($image_2)) {
                       echo $image_2;
                  ...
                  <div class="carousel-caption d-none d-md-block">
                    ...
                    <p class="todas-maiusculas texto-carrousel"><?php if (isset($sub_title_2)) {
                      echo $sub_title_2;
                    } ?>
                    </p>
                  </div>
                ...
                <div class="carousel-item">
                  <img src="<?php echo URLADM; ?>app/sts/assets/images/carrouselnucum/<?php if (isset($image_3)) {
                       echo $image_3;
                  ...
                  <div class="carousel-caption d-none d-md-block">
                    ...
                    <p class="todas-maiusculas texto-carrousel"><?php if (isset($sub_title_3)) {
                      echo $sub_title_3;
                    } ?>
                    </p>
                  </div>
                ...
                <div class="carousel-item">
                  <img src="<?php echo URLADM; ?>app/sts/assets/images/carrouselnucum/<?php if (isset($image_4)) {
                       echo $image_4;
                  ...
                  <div class="carousel-caption d-none d-md-block">
                    ...
                    <p class="todas-maiusculas texto-carrousel"><?php if (isset($sub_title_4)) {
                      echo $sub_title_4;
                    } ?>
                    </p>
                  </div>
                ...
                <div class="carousel-item">
                  <img src="<?php echo URLADM; ?>app/sts/assets/images/carrouselnucum/<?php if (isset($image_5)) {
                       echo $image_5;
                  ...
                  <div class="carousel-caption d-none d-md-block">
                    ...
                    <p class="todas-maiusculas texto-carrousel"><?php if (isset($sub_title_5)) {
                      echo $sub_title_5;
                    } ?>
                    </p>
                  </div>
                ...
                <div class="carousel-item">
                  <img src="<?php echo URLADM; ?>app/sts/assets/images/carrouselnucum/<?php if (isset($image_6)) {
                       echo $image_6;
                  ...
                  <div class="carousel-caption d-none d-md-block">
                    ...
                    <p class="todas-maiusculas texto-carrousel"><?php if (isset($sub_title_6)) {
                      echo $sub_title_6;
                    } ?>
                    </p>
                  </div>
  ...
  <div style="text-align:center;">
    <a href="<?php if (isset($link_btn_2)) {
      echo $link_btn_2;
    } ?>" class="btn btn-sm btn-info cor-botoes m-3 button_top"> <?php if (isset($text_btn_2)) {
       echo $text_btn_2;
     } ?> </a>
  </div>
</body>