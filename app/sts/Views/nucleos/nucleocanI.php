        ...
        <section class="mb-3">
            ...
            ?>
                    ...
                    <div class="row m-2">
                        <div class="col-md-3">
                            <div>
                                <img src="<?php echo URLADM; ?>app/sts/assets/images/nucleocanI/<?php if (isset($image_3)) {echo $image_3;} ?>" class="img-thumbnail d-block w-100"alt="Imagem de roda de capoeira">
                        ...
                        <div class="col-md-3">
                            <div>
                                <img src="<?php echo URLADM; ?>app/sts/assets/images/nucleocanI/<?php if (isset($image_4)) {echo $image_4;} ?>" class="img-thumbnail d-block w-100"alt="Imagem de roda de capoeira">
                        ...
                        <div class="col-md-3">
                            <div>
                                <img src="<?php echo URLADM; ?>app/sts/assets/images/nucleocanI/<?php if (isset($image_5)) {echo $image_5;} ?>" class="img-thumbnail d-block w-100"alt="Imagem de roda de capoeira">
                        ...
                        <div class="col-md-3">
                            <div>
                                <img src="<?php echo URLADM; ?>app/sts/assets/images/nucleocanI/<?php if (isset($image_6)) {echo $image_6;} ?>" class="img-thumbnail d-block w-100"alt="Imagem de roda de capoeira">
                    ...
                    <div class="row m-2">
                        <div class="col-md-3">
                            <div>
                                <img src="<?php echo URLADM; ?>app/sts/assets/images/nucleocanI/<?php if (isset($image_7)) {echo $image_7;} ?>" class="img-thumbnail d-block w-100"alt="Imagem de roda de capoeira">
                        ...
                        <div class="col-md-3">
                            <div>
                                <img src="<?php echo URLADM; ?>app/sts/assets/images/nucleocanI/<?php if (isset($image_8)) {echo $image_8;} ?>" class="img-thumbnail d-block w-100"alt="Imagem de roda de capoeira">
                        ...
                        <div class="col-md-3">
                            <div>
                                <img src="<?php echo URLADM; ?>app/sts/assets/images/nucleocanI/<?php if (isset($image_9)) {echo $image_9;} ?>" class="img-thumbnail d-block w-100"alt="Imagem de roda de capoeira">
                        ...
                        <div class="col-md-3">
                            <div>
                            <img src="<?php echo URLADM; ?>app/sts/assets/images/nucleocanI/<?php if (isset($image_10)) {echo $image_10;} ?>" class="img-thumbnail d-block w-100"alt="Imagem de roda de capoeira">
                    ...
                    <div class="row m-2">
                        ...
                        <div class="col-md-4">
                            ...
                            <img src="<?php echo URLADM; ?>app/sts/assets/images/nucleocanI/<?php if (isset($image_12)) {echo $image_12;} ?>" class="img-thumbnail d-block w-100"alt="Imagem de roda de capoeira">
          ...
          <div id="carousel_imagens" class="carousel slide" data-ride="carousel" >
            ...
            <div class="carousel-inner">
              <div class="carousel-item  active">
                <img src="<?php echo URLADM; ?>app/sts/assets/images/carrouselnucum/<?php if (isset($image_1)) {echo $image_1;}?>" class="d-block w-100" alt="Secullum Acadêmia">
              ...
              <div class="carousel-item">
                <img src="<?php echo URLADM; ?>app/sts/assets/images/carrouselnucum/<?php if (isset($image_2)) {echo $image_2;}?>" class="d-block w-100" alt="Secullum Acesso">
                <div class="carousel-caption d-none d-md-block">
              ...
              <div class="carousel-item">
                <img src="<?php echo URLADM; ?>app/sts/assets/images/carrouselnucum/<?php if (isset($image_3)) {echo $image_3;}?>" class="d-block w-100" alt="Secullum Checkin">
                <div class="carousel-caption d-none d-md-block">
               ...
               <div class="carousel-item">
                 <img src="<?php echo URLADM; ?>app/sts/assets/images/carrouselnucum/<?php if (isset($image_4)) {echo $image_4;}?>" class="d-block w-100" alt="Secullum Estacionamento">
                <div class="carousel-caption d-none d-md-block">
              ...
              <div class="carousel-item">
                <img src="<?php echo URLADM; ?>app/sts/assets/images/carrouselnucum/<?php if (isset($image_5)) {echo $image_5;}?>" class="d-block w-100" alt="Secullum Ponto">
                <div class="carousel-caption d-none d-md-block">
              ...
              <div class="carousel-item">
                <img src="<?php echo URLADM; ?>app/sts/assets/images/carrouselnucum/<?php if (isset($image_6)) {echo $image_6;}?>" class="d-block w-100" alt="Secullum Escola">
                <div class="carousel-caption d-none d-md-block">
