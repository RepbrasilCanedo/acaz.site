...
<body style="background: url(<?php echo URL; ?>app/sts/assets/images/Papel_Parede.jpg) left center;">
    <div class="container max-width">
            ...
            <section class="mb-3">
                ...
                if (!empty($this->data['nucleoarat']['conteudo'])) {
                    foreach($this->data['nucleoarat']['conteudo'] as $nucleoarat) {
                        extract($nucleoarat);
            ...
            <session class="mb-3">
                <div class="row">
                    <div class="col md-12">         
                        <?php
                        // Acessa o IF quando encontrou algum registro no banco de dados
                        if (!empty($this->data['nucleoarat']['carroussel'][0])) {
                            extract($this->data['nucleoarat']['carroussel'][0]);
                        ...
                        <div id="carousel_imagens" class="carousel slide" data-ride="carousel" >
                                ...
                                <div class="carousel-item  active">
                                    <img src="<?php echo URLADM; ?>app/sts/assets/images/carrouselarataca/<?php if (isset($image_1)) {echo $image_1;}?>" class="d-block w-100" alt="Imagem de roda de capoeira">
                                ...
                                <div class="carousel-item">
                                    <img src="<?php echo URLADM; ?>app/sts/assets/images/carrouselarataca/<?php if (isset($image_2)) {echo $image_2;}?>" class="d-block w-100" alt="Imagem de roda de capoeira">
                                    <div class="carousel-caption d-none d-md-block">
                                    ...
                                    <div class="carousel-item">
                                        <img src="<?php echo URLADM; ?>app/sts/assets/images/carrouselarataca/<?php if (isset($image_3)) {echo $image_3;}?>" class="d-block w-100" alt="Imagem de roda de capoeira">
                                        <div class="carousel-caption d-none d-md-block">
                                    ...
                                    <div class="carousel-item">
                                        <img src="<?php echo URLADM; ?>app/sts/assets/images/carrouselarataca/<?php if (isset($image_4)) {echo $image_4;}?>" class="d-block w-100" alt="Imagem de roda de capoeira">
                                        <div class="carousel-caption d-none d-md-block">
                                    ...
                                    <div class="carousel-item">
                                        <img src="<?php echo URLADM; ?>app/sts/assets/images/carrouselarataca/<?php if (isset($image_5)) {echo $image_5;}?>" class="d-block w-100" alt="Imagem de roda de capoeira">
                                        <div class="carousel-caption d-none d-md-block">
                                    ...
                                    <div class="carousel-item">
                                        <img src="<?php echo URLADM; ?>app/sts/assets/images/carrouselarataca/<?php if (isset($image_6)) {echo $image_6;}?>" class="d-block w-100" alt="Imagem de roda de capoeira">
                                        <div class="carousel-caption d-none d-md-block">
