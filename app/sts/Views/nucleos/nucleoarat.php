            ...
            if (!empty($this->data['nucleoarat']['conteudo'][0])) {
                ...
                <div class="centralizar">
                        ...
                        <div class="card mb-3">
                            <div class="row g-0">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <img src="<?php echo URLADM; ?>app/sts/assets/images/nucleoarat/<?php if (isset($image_13)) {
                                        echo $image_13;
                    ...
                    <div class="row m-2">
                        <div class="col-md-3">
                            <div>
                                <img src="<?php echo URLADM; ?>app/sts/assets/images/nucleoarat/<?php if (isset($image_3)) {
                                       echo $image_3;
                        ...
                        <div class="col-md-3">
                            <div>
                                <img src="<?php echo URLADM; ?>app/sts/assets/images/nucleoarat/<?php if (isset($image_4)) {
                                       echo $image_4;
                                   } ?>" class="img-thumbnail d-block w-100" alt="Imagem de roda de capoeira">
                        ...
                        <div class="col-md-3">
                            <div>
                                <img src="<?php echo URLADM; ?>app/sts/assets/images/nucleoarat/<?php if (isset($image_5)) {
                                       echo $image_5;
                                   } ?>" class="img-thumbnail d-block w-100" alt="Imagem de roda de capoeira">
                        ...
                        <div class="col-md-3">
                            <div>
                                <img src="<?php echo URLADM; ?>app/sts/assets/images/nucleoarat/<?php if (isset($image_6)) {
                                       echo $image_6;
                                   } ?>" class="img-thumbnail d-block w-100" alt="Imagem de roda de capoeira">
                        ...
                        <div id="carousel_imagens" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item  active">
                                    <img src="<?php echo URLADM; ?>app/sts/assets/images/carrouselarataca/<?php if (isset($image_1)) {
                                           echo $image_1;
                                       } ?>"
                                ...
                                <div class="carousel-item">
                                    <img src="<?php echo URLADM; ?>app/sts/assets/images/carrouselarataca/<?php if (isset($image_2)) {
                                           echo $image_2;
                                       } ?>"
                                        class="d-block w-100" alt="Imagem de roda de capoeira">
                                    <div class="carousel-caption d-none d-md-block">
                                ...
                                <div class="carousel-item">
                                    <img src="<?php echo URLADM; ?>app/sts/assets/images/carrouselarataca/<?php if (isset($image_3)) {
                                           echo $image_3;
                                       } ?>"
                                        class="d-block w-100" alt="Imagem de roda de capoeira">
                                    <div class="carousel-caption d-none d-md-block">
                                ...
                                <div class="carousel-item">
                                    <img src="<?php echo URLADM; ?>app/sts/assets/images/carrouselarataca/<?php if (isset($image_4)) {
                                           echo $image_4;
                                       } ?>"
                                        class="d-block w-100" alt="Imagem de roda de capoeira">
                                    <div class="carousel-caption d-none d-md-block">
                                ...
                                <div class="carousel-item">
                                    <img src="<?php echo URLADM; ?>app/sts/assets/images/carrouselarataca/<?php if (isset($image_5)) {
                                           echo $image_5;
                                       } ?>"
                                        class="d-block w-100" alt="Imagem de roda de capoeira">
                                    <div class="carousel-caption d-none d-md-block">
                                ...
                                <div class="carousel-item">
                                    <img src="<?php echo URLADM; ?>app/sts/assets/images/carrouselarataca/<?php if (isset($image_6)) {
                                           echo $image_6;
                                       } ?>"
                                        class="d-block w-100" alt="Imagem de roda de capoeira">
                                    <div class="carousel-caption d-none d-md-block">
