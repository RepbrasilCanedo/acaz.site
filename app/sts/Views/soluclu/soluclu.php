...
<body style="background: url(<?php echo URL; ?>app/sts/assets/images/Papel_Parede.jpg) left center;">
    <div class="container max-width">
            ...
            if (!empty($this->data['soluclu'])) {
                foreach ($this->data['soluclu'] as $soluclu) {
                    extract($soluclu);
                    
                   // echo ('<pre>');print_r($soluclu);echo ('</pre>');
            ?>
    <section>
        <div class=" mt-3">
            <div class="row">
                <div class= "col md-12">
                    <div>
                        <img src="<?php echo URL; ?>app/sts/assets/images/soluclu/<?php if (isset($image_top )) {echo $image_top ;}?>" class="d-block w-100">
            ...
            <div class="row">
                <div class= "col md-12 p-2">
                    <div>
                        <img src="<?php echo URL; ?>app/sts/assets/images/soluclu/<?php if (isset($image_center )) {echo $image_center ;}?>" class="d-block w-100">
                        <div class="carousel-caption d-none d-md-block">
