...
<body style="background: url(<?php echo URL; ?>app/sts/assets/images/Papel_Parede.jpg) left center;">
    <div class="container max-width">
            ...
            if (!empty($this->data['soluesc'])) {
                foreach ($this->data['soluesc'] as $soluesc) {
                    extract($soluesc);
                    //echo ('<pre>');print_r($soluesc);echo ('</pre>');
            ?>
                    <section>
                        <div class="container mt-3">
                            <div class="row">
                                <div class="col md-12">
                                    <div>
                                        <img src="<?php echo URL; ?>app/sts/assets/images/soluesc/<?php if (isset($image_top )) {echo $image_top ;}?>" class="d-block w-100">
                            ...
                            <div class="row">
                                <div class="col md-12 p-3">
                                    <div>
                                        <img src="<?php echo URL; ?>app/sts/assets/images/soluesc/<?php if (isset($image_center )) {echo $image_center ;}?>" class="d-block w-100">
                                        <div class="carousel-caption d-none d-md-block">
