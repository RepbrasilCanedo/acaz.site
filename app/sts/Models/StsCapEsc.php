...
class StsCapEsc
{
    ...
    {  
        $capesc = new \Sts\Models\helper\StsRead();
        $capesc->fullRead("SELECT id, title, content, image, sub_title_1, content_1, image_2, sub_title_2, content_2, 
        ...
        FROM sts_cap_esc WHERE sts_situation=:sts_situation", "sts_situation=1");
        $this->data= $capesc->getResult();
