...
class StsProdCat
{
    ...
    {  
        $prodcat = new \Sts\Models\helper\StsRead();
        $prodcat->fullRead("SELECT id, title, content, image, sub_title_1, content_1, image_2, sub_title_2, content_2, 
        ...
        FROM sts_products_cat WHERE sts_situation=:sts_situation", "sts_situation=1");
        $this->data= $prodcat->getResult();
