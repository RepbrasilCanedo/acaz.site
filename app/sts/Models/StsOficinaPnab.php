...
class StsOficinaPnab
{
    ...
    { 
        $oficinapnab = new \Sts\Models\helper\StsRead();
        $oficinapnab->fullRead("SELECT id, title, content, image_1, sub_title_1, content_1, image_2, sub_title_2, content_2, 
