...
class StsHistoricoAcaz
{
    ...
    {  
        $historicoacaz = new \Sts\Models\helper\StsRead();
        $historicoacaz->fullRead("SELECT id, title, content, image, sub_title_1, content_1, image_2, sub_title_2, content_2, 
        ...
        FROM sts_historico_acaz WHERE sts_situation=:sts_situation", "sts_situation=1");
