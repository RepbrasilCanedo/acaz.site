...
class StsEventoLev
{
    ...
    {  
        $eventolev = new \Sts\Models\helper\StsRead();
        $eventolev->fullRead("SELECT id, title, content, image, sub_title_1, content_1, image_2, sub_title_2, content_2, 
        ...
        FROM sts_evento_lev WHERE sts_situation=:sts_situation", "sts_situation=1");
        $this->data= $eventolev->getResult();
