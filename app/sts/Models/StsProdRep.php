...
class StsProdRep
{
    ...
    {  
        $prodrep = new \Sts\Models\helper\StsRead();
        $prodrep->fullRead("SELECT id, title, content, image, sub_title_1, content_1, image_2, sub_title_2, content_2, 
        ...
        FROM sts_products_rep WHERE sts_situation=:sts_situation", "sts_situation=1");
        $this->data= $prodrep->getResult();
