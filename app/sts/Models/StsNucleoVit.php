...
class StsNucleoVit
{
    ...
    {  
        ...
        $viewHomeTop->fullRead("SELECT 	image_1, titlte_1, sub_title_1, link_url_1, link_text_1, image_2, titlte_2, sub_title_2, link_url_2, link_text_2, image_3, titlte_3, sub_title_3, link_url_3, link_text_3, image_4, titlte_4, sub_title_4, link_url_4, link_text_4, image_5, titlte_5, sub_title_5, link_url_5, link_text_5, image_6, titlte_6, sub_title_6, link_url_6, link_text_6 FROM sts_carr_nuc_vitoria WHERE id=:id LIMIT :limit", "id=1&limit=1");
        $this->data['carroussel']= $viewHomeTop->getResult();

        $nucleocanIV = new \Sts\Models\helper\StsRead();
        $nucleocanIV->fullRead("SELECT id, title, content, image, sub_title_1, content_1, image_2, sub_title_2, content_2, 
        ...
        FROM sts_nucleo_vit WHERE sts_situation=:sts_situation", "sts_situation=1");
        $this->data['conteudo']= $nucleocanIV->getResult();
