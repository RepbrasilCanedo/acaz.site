...
class StsCaravanaCult
{
    ...
    { 
        $caravanacult = new \Sts\Models\helper\StsRead();
        $caravanacult->fullRead("SELECT id, title, content, image_1, sub_title_1, content_1, image_2, sub_title_2, content_2, 
         ...
         FROM sts_caravana_cult WHERE sts_situation=:sts_situation", "sts_situation=1");
        
        $this->data['conteudo']= $caravanacult->getResult();
